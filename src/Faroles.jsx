...
export default function Faroles() {
  ...
  const faroles = [
    ...
    { nombre: 'Farol Halógeno Osram', imagen: '/farol_osram.png' },
    { nombre: 'Farol Xenón Bosch', imagen: '/farol_bosch.png' },
      ...
      <main className="main-content">
        ...
        <section className="content">
          <div className="productos-section">
            <h2>Faroles Disponibles</h2>
            <div className="productos-grid">
              {farolesFiltrados.map((prod, index) => (
