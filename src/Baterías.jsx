...
export default function Baterias() {
  ...
  const baterias = [
    ...
    { nombre: 'Batería LTH', imagen: '/bateria_lth.png' },
    { nombre: 'Batería Interstate', imagen: '/bateria_interstate.png' },
      ...
      <main className="main-content">
        ...
        <section className="content">
          <div className="productos-section">
            <h2>Baterías Disponibles</h2>
            <div className="productos-grid">
              {bateriasFiltradas.map((prod, index) => (
